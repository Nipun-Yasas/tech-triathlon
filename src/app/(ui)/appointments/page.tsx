...
import { Box, Typography, Stepper, Step, StepLabel, Button, Paper, Card, CardContent, CardActionArea, FormControl, InputLabel, Select, MenuItem, FormHelperText } from '@mui/material';
...
export default function AppointmentBooking() {
  ...
  const onTimeSlotSubmit = (data: { timeSlot: string }) => {
    if (!selectedDate) return;
    
    console.log('Time slot selected:', data);
    
    // Generate a reference number
    const ref = `BK-${Math.floor(Math.random() * 1000000).toString().padStart(6, '0')}`;
  ...
  const getStepContent = () => {
    switch (activeStep) {
      case 0:
        return (
          <Box>
            <Typography variant="h5" gutterBottom sx={{ color: '#333333', mb: 3, textAlign: 'center' }}>
              Select Government Department
            </Typography>
            <Typography variant="body1" sx={{ color: '#7E7E7E', mb: 4, textAlign: 'center' }}>
              ...
              {departments.map((dept) => (
                <Card 
                  ...
                  sx={{ 
                    height: '160px',
                    cursor: 'pointer',
                    borderColor: selectedDepartment === dept.id ? '#4CAF50' : '#E0E0E0',
                    borderWidth: selectedDepartment === dept.id ? 3 : 1,
                    borderStyle: 'solid',
                    backgroundColor: selectedDepartment === dept.id ? '#F1F8E9' : '#FFFFFF',
                    ...
                    <CardContent sx={{ textAlign: 'center', p: 1 }}>
                      ...
                      <Typography 
                        ...
                        sx={{ 
                          ...
                          fontSize: '0.95rem',
                          lineHeight: 1.3,
                          fontWeight: selectedDepartment === dept.id ? 600 : 500
                        }}
                      >
                        {dept.name}
                      </Typography>
                      {selectedDepartment === dept.id && (
                        <Typography variant="body2" sx={{ color: '#4CAF50', mt: 1, fontWeight: 600 }}>
                          ✓ Selected
                        </Typography>
                      )}
                    </CardContent>
      ...
      case 1:
        return (
          <Box component="form" onSubmit={serviceForm.handleSubmit(onServiceSubmit)}>
            <Typography variant="h5" gutterBottom sx={{ color: '#333333', textAlign: 'center', mb: 2 }}>
              Choose Your Service
            </Typography>
            <Typography variant="body1" sx={{ color: '#7E7E7E', textAlign: 'center', mb: 4 }}>
      ...
      case 2:
        return (
          <Box component="form" onSubmit={timeSlotForm.handleSubmit(onTimeSlotSubmit)}>
            <Typography variant="h5" gutterBottom sx={{ color: '#333333', textAlign: 'center', mb: 2 }}>
              Select Date & Time
            </Typography>
            <Typography variant="body1" sx={{ color: '#7E7E7E', textAlign: 'center', mb: 4 }}>
            ...
            <Box sx={{ 
              ...
              <Box sx={{ textAlign: 'center' }}>
                ...
                {selectedDate ? (
                  <Box>
                    <Paper sx={{ p: 2, mb: 3, backgroundColor: '#F1F8E9', border: '1px solid #A5D6A7' }}>
                  ...
                  <Paper sx={{ p: 4, backgroundColor: '#F9F9F6', border: '1px dashed #C8E6C9' }}>
      ...
      case 3:
        return (
          <Box sx={{ textAlign: 'center', maxWidth: '600px', mx: 'auto' }}>
            <Box sx={{ mb: 4 }}>
              <Typography variant="h4" gutterBottom sx={{ color: '#388E3C', fontWeight: 700 }}>
            ...
            <Paper elevation={3} sx={{ 
              ...
              <Box sx={{ mb: 4 }}>
                ...
                <Box sx={{
                  ...
                  <Typography variant="h5" sx={{ color: '#4CAF50', mb: 1, fontWeight: 700 }}>
                    QR Code
                  </Typography>
              ...
              <Box sx={{ textAlign: 'left' }}>
                <Typography variant="h6" gutterBottom sx={{ color: '#333333', textAlign: 'center', mb: 3 }}>
                  📋 Appointment Details
                </Typography>
                ...
                <Box sx={{ 
                  ...
                  <Typography variant="body1" sx={{ color: '#7E7E7E', fontWeight: 600 }}>
                    Department:
                  </Typography>
                  ...
                  <Typography variant="body1" sx={{ color: '#333333' }}>
                    {getAvailableServices().find(s => s.id === Number(serviceForm.getValues().service))?.name}
                  </Typography>
                ...
                <Paper sx={{ p: 3, backgroundColor: '#E8F5E8', border: '1px solid #A5D6A7' }}>
                  <Typography variant="body2" sx={{ color: '#333333', fontWeight: 600, mb: 1 }}>
                    📌 Important Reminders:
                  </Typography>
  ...
  return (
    <Box sx={{ maxWidth: '1200px', mx: 'auto', px: 2 }}>
      ...
      <Box sx={{ textAlign: 'center', mb: 6 }}>
        <Typography variant="h3" component="h1" gutterBottom sx={{ color: '#333333', fontWeight: 700 }}>
          Book an Appointment
        </Typography>
        <Typography variant="h6" sx={{ color: '#7E7E7E', maxWidth: '600px', mx: 'auto' }}>
          Schedule your government service appointment in just a few simple steps
        </Typography>
      </Box>
      
      {/* Progress Stepper */}
      <Paper elevation={1} sx={{ p: 3, mb: 4, backgroundColor: '#F9F9F6', borderRadius: 3 }}>
      ...
      {/* Navigation Buttons */}
      {activeStep !== 3 && (
        <Paper elevation={1} sx={{ p: 3, backgroundColor: '#F9F9F6', borderRadius: 3 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
              ...
              >
                {activeStep === steps.length - 2 ? 'Confirm Booking' : 'Next Step'}
              </Button>
            </Box>
          </Box>
        </Paper>
